...
export const api = {
  ...
  listDeletedTasks: (projectId) => generationTasksApi.list(projectId, { deletedOnly: true }),
  createTask: generationTasksApi.create,
  retryTask: generationTasksApi.retry,
  deleteTask: generationTasksApi.remove,
  restoreTask: generationTasksApi.restore,
  deleteTaskPermanent: generationTasksApi.removePermanent,
