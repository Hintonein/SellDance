...
export const creationApi = {
  ...
  smartEdit: (projectId, payload) => request(`/projects/${projectId}/creation/smart-edit`, { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(payload) }),
  oneClick: (projectId, payload) => request(`/projects/${projectId}/creation/one-click`, { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(payload) }),
  ...
  listWorkflowTasks: (projectId) => request(`/projects/${projectId}/creation-workflow-tasks`),
  getWorkflowTask: (projectId, taskId) => request(`/projects/${projectId}/creation-workflow-tasks/${taskId}`),
};
