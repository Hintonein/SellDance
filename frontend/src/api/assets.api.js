...
export const assetsApi = {
  ...
  listAnalysisTasks: (projectId) => request(`/projects/${projectId}/assets/analysis-tasks`),
  getAnalysisTask: (projectId, taskId) => request(`/projects/${projectId}/assets/analysis-tasks/${taskId}`),
